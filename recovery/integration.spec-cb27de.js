...
describe('decodeSingle', function () {
    ...
    xdescribe("EAN-extended", function() {
        var config = {
                inputStream: {
                    size: 800,
                    singleChannel: false
    ...
    xdescribe("I2of5 with localization", function() {
        var config = {
                inputStream: {
                    size: 800,
                    singleChannel: false
